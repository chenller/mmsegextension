...
这个工具箱将基于 **MMSegmentation v0.x 版本**开发的模型（例如ViT-Adapter）迁移到功能更丰富、性能更优化的 **MMSegmentation v1.x版本**。
...
**使用:** [使用现有模型进行训练和测试](https://github.com/open-mmlab/mmsegmentation/blob/main/docs/en/user_guides/4_train_test.md)
